        ...
        <div class="container">
            ...
            <div class="row ">
                <div class="col-md-12 mb-4 ">
                    <div class="shadow bg-white p-3 border">
                            ...
                            <div class="col-md-12 mb-3" wire:ignore>
                                ...
                                <div class="d-md-flex align-items-start">
                                    <div class="nav col-md-3 flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                        ...
                                        <button wire:loading.attr='disabled' class="nav-link fw-bold active"
                                    ...
                                    <div class="tab-content col-md-9" id="v-pills-tabContent">
                                        <div class="tab-pane active show fade" id="cashOnDeliveryTab" role="tabpanel"
                                            ...
                                            <hr />
                                            <button type="button" wire:loading.attr='disabled' wire:click="cod"
                                                class="btn btn-primary">
                                                <span wire:loading.remove wire:target='cod'>
                                                    Place Order (Cash on Delivery)
                                                </span>
                                                <span wire:loading wire:target='cod'>
                                                    Placeing Order
                                                </span>
                                            </button>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="onlinePayment" role="tabpanel"
                                            ...
                                            {{-- <button type="button" wire:loading.attr='disabled'
                                                wire:click="checkout" class="btn btn-warning">
...
@push('scripts')
<script
    src="https://www.paypal.com/sdk/js?client-id=AdDoYJZRKKmIRUT26HFi1koRl1AKBwws-TJhHo9V1lSYSumOiV6zHTWmBln8E2-NSXELTnEx9BEwEOli&currency=USD">
</script>
<script>
    paypal.Buttons({
        onClick: function() 
